...
<body>
    ...
    <h4 class=" m-0 p-1 text-center text-light" style="background-color: #21516f;">Buscar empleado</h4>
    <section class="card p-2 text-center" style="width: 350px; margin:auto; margin-top:40px;">
        ...
        <form action="search_empl.php" method="post">
            <div class="mb-2">
                <select name="searchType" class="form-control" required>
                    <option>Clic para seleccionar una opción ... </option>
            ...
            <button type="submit" class="btn btn-success form-control">Buscar empleado</button>
        </form>
