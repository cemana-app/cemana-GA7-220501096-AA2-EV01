...
<body>
    ...
    <h4 class=" m-0 p-1 text-center text-light" style="background-color: #21516f;">Modificar empleado</h4>
        ...
        if (isset($_GET['clientID'])) {
            ...
            if ($stmt = mysqli_prepare($link, $sql)) {
                ...
                if (mysqli_stmt_execute($stmt)) {
                    ...
                    echo "<div class='alert alert-danger'>Error retrieving employee data.</div>";
                    exit;
                }
            } else {
